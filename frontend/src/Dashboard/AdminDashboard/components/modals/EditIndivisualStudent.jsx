...
export default function EditIndividualStudentModal({
  ...
  useEffect(() => {
    if (student && attendance) {
      ...
      if (Array.isArray(student.batches?.subjectId)) {
        subjectId = student.batches.subjectId[0]?.subjectId;
      } else if (typeof student.batches?.subjectId === "object") {
        subjectId = student.batches.subjectId?.subjectId;
      } else if (Array.isArray(student.batches)) {
        subjectId = student.batches[0]?.subjectId || "";
      }
                ...
                <div className="mt-1">
                  <span className="text-xs bg-purple-100 text-purple-700 rounded-full px-2 py-1">
                    {(() => {
                      if (Array.isArray(student.batches?.subjectId)) {
                        return (
                          student.batches.subjectId[0]?.name ||
                          "No Subject Assigned"
                        );
                      } else if (
                        typeof student.batches?.subjectId === "object"
                      ) {
                        return (
                        ...
                        return (
                          student.batches[0]?.name || "No Subject Assigned"
                        );
                      }
